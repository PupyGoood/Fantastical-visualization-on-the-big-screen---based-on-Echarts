$(function(){
    ...
    var point = [
    	[113.752171,36.068716],
    	[116.759037,28.072046],
    	[103.73788,36.061257]
	]
    var maker;
	...
	var barData = ['6','0','0','0','0','0','0','8','1','2','0','3','0','1','5','0','2','1','0','5','0','0','0','1','1','0','2','0','0','18'];
	var lineData = barData.map(value => parseInt(value)); // Example line data, add your own logic
		...
		tooltip: {
			...
			formatter: function(params) {
				if (params.seriesType === 'bar') {
					return '本月' + params.name + '号运单数：' + params.data;
				} else if (params.seriesType === 'line') {
					return '本月' + params.name + '号数据：' + params.data;
				}
			}
		},
		grid: {
